...
cat <<EOT-PGAGENT > $WD/pgAgent/build-pgagent.sh
    ...
    cp -pR /opt/local/Current/boost/lib/libboost_filesystem.dylib \$PG_STAGING/pgAgent/lib || _die "Failed to copy required dylibs to staging directory"
    cp -pR /opt/local/Current/boost/lib/libboost_system.dylib \$PG_STAGING/pgAgent/lib || _die "Failed to copy required dylibs to staging directory"
    cp -pR /opt/local/Current/boost/lib/libboost_thread.dylib \$PG_STAGING/pgAgent/lib || _die "Failed to copy required dylibs to staging directory"
    cp -pR /opt/local/Current/boost/lib/libboost_chrono.dylib \$PG_STAGING/pgAgent/lib || _die "Failed to copy required dylibs to staging directory"
    cp -pR /opt/local/Current/boost/lib/libboost_regex.dylib \$PG_STAGING/pgAgent/lib || _die "Failed to copy required dylibs to staging directory"
    cp -pR /opt/local/Current/boost/lib/libboost_date_time.dylib \$PG_STAGING/pgAgent/lib || _die "Failed to copy required dylibs to staging directory"
    cp -pR /opt/local/Current/boost/lib/libboost_atomic.dylib \$PG_STAGING/pgAgent/lib || _die "Failed to copy required dylibs to staging directory"
