...
_build_ReplicationServer_solaris_x64() {
   ...
   # Build the validateUserClient binary
    if [ ! -f $WD/MetaInstaller/source/MetaInstaller.solaris-x64/validateUser/validateUserClient.o ]; then
        scp -r $WD/MetaInstaller/scripts/solaris-x64/validateUser $PG_SSH_SOLARIS_X64:$PG_PATH_SOLARIS_X64/ReplicationServer/source/ReplicationServer.solaris-x64/ || _die "Failed to copy validateUser source files"
