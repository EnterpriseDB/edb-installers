...
_postprocess_ReplicationServer_solaris_sparc() {
    ...
    cp resources/xdg/pg-launchReplicationServer.desktop staging/solaris-sparc/scripts/xdg/pg-launchReplicationServer_$PG_VERSION_STR.desktop || _die "Failed to copy the xdg files "
    cp resources/xdg/pg-postgresql.directory staging/solaris-sparc/scripts/xdg/pg-postgresql_$PG_VERSION_STR.directory || _die "Failed to copy the xdg files "

    # Copy in the menu pick images
    mkdir -p staging/solaris-sparc/scripts/images || _die "Failed to create a directory for the menu pick images"
    cp resources/pg-launchReplicationConsole.png staging/solaris-sparc/scripts/images/pg-launchReplicationConsole-$PG_VERSION_STR.png || _die "Failed to copy the menu pick images (resources/pg-launchReplicationConsole.png)"
