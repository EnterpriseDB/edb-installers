...
_prep_ReplicationServer() {
    ...
    rm -f $WD/ReplicationServer/staging/*.xml
...
_postprocess_ReplicationServer() {
    ...
    #_registration_plus_postprocess(STAGING DIRECTORY, COMPONENT NAME, VERSION VARIABLE, INI, REGISTRY_PREFIX, REGISTRY_PREFIX_WIN, COMONENT TYPE PRODUCT_DESCRIPTION, PRODUCT_VERSION)
    _registration_plus_postprocess "$WD/ReplicationServer/staging"  "xDBReplicationServer" "xDBReplicationServerVersion" "/etc/postgres-reg.ini" "xDBReplicationServer" "xDBReplicationServer" "xDB Replication Server" "$PG_VERSION_REPLICATIONSERVER"
