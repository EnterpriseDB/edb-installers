...
EOT
    ...
    unix2dos $WD/ReplicationServer/staging/windows/repconsole/doc/datavalidator-readme.txt || _die "Failed to convert datavalidator readme in dos readable format."
