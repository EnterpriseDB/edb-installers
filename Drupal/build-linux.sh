...
_postprocess_Drupal_linux() {
    ...
    cp resources/xdg/enterprisedb-launchDrupal.desktop staging/linux/scripts/xdg/enterprisedb-launchDrupal.desktop || _die "Failed to copy the xdg files (resources)"
    ...
    cp resources/enterprisedb-launchDrupal.png staging/linux/scripts/images || _die "Failed to copy the menu pick images (resources/launchDrupal.png)"
