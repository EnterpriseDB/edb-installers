...
_build_MigrationToolKit_linux() {
    ...
    ssh $PG_SSH_LINUX "cd $PG_PATH_LINUX/MigrationToolKit/source/migrationtoolkit.linux; JAVA_HOME=$PG_JAVA_HOME_LINUX $PG_ANT_HOME_LINUX/bin/ant install" || _die "Couldn't build the migrationtoolkit"
