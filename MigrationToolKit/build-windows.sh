...
_prep_MigrationToolKit_windows() {
    ...
    cp pgJDBC-$PG_VERSION_PGJDBC/postgresql-$PG_VERSION_PGJDBC.jre7.jar migrationtoolkit.windows/lib/ || _die "Failed to copy the pg-jdbc driver"
    ...
    cp $WD/tarballs/edb-jdbc17.jar migrationtoolkit.windows/lib/ || _die "Failed to copy the edb-jdbc driver"
