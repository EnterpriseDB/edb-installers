...
copy release\UpdateManager.exe %SOURCE_PATH%\stackbuilderplus.staging\bin || SET ERRMSG=ERROR: Couldn't copy the UpdateManager binary to staging directory && GOTO EXIT_WITH_ERROR
