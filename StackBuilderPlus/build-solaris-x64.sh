...
EOT
    ...
    ssh $PG_SSH_SOLARIS_X64 "cp /usr/lib/64/libexpat.so* $PG_PATH_SOLARIS_X64/StackBuilderPlus/staging/solaris-x64/lib" || _die "Failed to copy dependent library (libexpat.so) in staging directory (solaris-x64)"
