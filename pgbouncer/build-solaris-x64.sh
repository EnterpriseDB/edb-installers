...
EOT
    ...
    ssh $PG_SSH_SOLARIS_X64 "cp -R /usr/local/lib/libreadline.so* $PG_PATH_SOLARIS_X64/pgbouncer/staging/solaris-x64/instscripts/" || _die "Failed to copy the dependency library"
