...
_prep_pgbouncer_linux_x64() {
    ...
    cp $WD/pgbouncer/resources/README.pgbouncer $WD/pgbouncer/staging/linux-x64/pgbouncer/doc || _die "Couldn't copy README.pgbouncer to staging doc directory"
...
_build_pgbouncer_linux_x64() {
    ...
    ssh $PG_SSH_LINUX_X64 "cp -R /usr/lib64/libreadline.so* $PG_PATH_LINUX_X64/pgbouncer/staging/linux-x64/instscripts/" || _die "Failed to copy the dependency library"
