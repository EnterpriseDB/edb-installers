...
_prep_metainstaller_linux() {
    ...
    cp -R "$WD/output/stackbuilderplus-$PG_VERSION_SBP-$PG_BUILDNUM_SBP-linux.run"  $WD/MetaInstaller/staging/linux || _die "Failed to copy the stackbuilderplus installer (staging/linux/stackbuilderplus-$PG_PACKAGE_SBP-$PG_BUILDNUM_SBP-linux.run)"
