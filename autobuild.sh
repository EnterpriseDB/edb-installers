...
declare -a PACKAGES_ARR=(SERVER PGAGENT LANGUAGEPACK)
...
usage()
{
        ...
        echo "    Examples:"
        echo "     $BASENAME -skipbuild 0 -platforms -packages "server,postgis,pgagent""
...
./build.sh $SKIPBUILD 2>&1 | tee output/build-14.log
