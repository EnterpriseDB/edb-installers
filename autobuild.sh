...
declare -a DECOUPLED_ARR=(APACHEHTTPD APACHEPHP PHPPGADMIN PGJDBC PSQLODBC NPGSQL PGBOUNCER MIGRATIONTOOLKIT UPDATE_MONITOR PEMHTTPD LANGUAGEPACK PEM)
...
EOF
	...
	installername=$( GetInstallerName $PACKAGE_NAME )
        ...
        scp -r output/*${installername}*${platInstallerName} output/3rd_party_libraries_list output/symbols output/build-12.log buildfarm@builds.enterprisedb.com:$remote_location >> autobuild.log 2>&1
}
