...
declare -a PACKAGES_ARR=(SERVER POSTGIS SLONY PGAGENT PGMEMCACHE PGBOUNCER MIGRATIONTOOLKIT SQLPROTECT LANGUAGEPACK)
declare -a PLATFORMS_ARR=(LINUX LINUX_X64 WINDOWS WINDOWS_X64 OSX)
declare -a ENABLED_PKG_ARR=()
declare -a ENABLED_PLAT_ARR=()
declare -a DECOUPLED_ARR=(MIGRATIONTOOLKIT PGAGENT LANGUAGEPACK)
