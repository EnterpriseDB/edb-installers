...
EOF
	...
	installername=$( GetInstallerName $PACKAGE_NAME )
        ...
        scp -r output/*${installername}*${platInstallerName} output/3rd_party_libraries_list output/symbols output/build-10.log buildfarm@builds.enterprisedb.com:$remote_location >> autobuild.log 2>&1
}
