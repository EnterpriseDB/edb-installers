...
_postprocess_server_linux_x64() {
    ...
    cp resources/xdg/pg-doc-installation-notes.desktop staging/linux-x64/scripts/xdg/pg-doc-installation-notes-$PG_MAJOR_VERSION.desktop || _die "Failed to copy a menu pick"
