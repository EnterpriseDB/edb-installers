...
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxbase*u_net_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxbase*u_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxbase*u_xml_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw*u_adv_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw*u_aui_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw*u_core_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw*u_html_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw*u_xrc_vc_x64_custom.dll $installation_directory/bin
