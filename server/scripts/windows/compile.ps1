...
$configuration = $configuration -replace 'icu\s*=>\s*undef', "icu       => '$icu_directory'"
$configuration = $configuration -replace 'lz4\s*=>\s*undef', "lz4       =>  '$lz4_directory'"
$configuration = $configuration -replace 'zstd\s*=>\s*undef', "zstd      => '$zstd_directory'"
$configuration = $configuration -replace 'nls\s*=>\s*undef', "nls       => '$gettext_directory'"
$configuration = $configuration -replace 'tcl\s*=>\s*undef', "tcl       => '$tcl_directory'"
$configuration = $configuration -replace 'perl\s*=>\s*undef', "perl      => '$perl_directory'"
$configuration = $configuration -replace 'python\s*=>\s*undef', "python    => '$python_directory'"
$configuration = $configuration -replace 'openssl\s*=>\s*undef', "openssl   => '$openssl_directory'"
$configuration = $configuration -replace 'uuid\s*=>\s*undef', "uuid      => '$uuid_directory'"
$configuration = $configuration -replace 'xml\s*=>\s*undef', "xml       => '$xml_directory'"
$configuration = $configuration -replace 'xslt\s*=>\s*undef', "xslt      => '$xslt_directory'"
$configuration = $configuration -replace 'zlib\s*=>\s*undef', "zlib      => '$zlib_directory'"
...
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxbase329u_net_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxbase329u_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxbase329u_xml_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw329u_adv_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw329u_aui_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw329u_core_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw329u_html_vc_x64_custom.dll $installation_directory/bin
Copy-Item $wxwidgets_directory/lib/vc_x64_dll/wxmsw329u_xrc_vc_x64_custom.dll $installation_directory/bin
