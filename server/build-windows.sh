...
EOT
    ...
    ssh $PG_SSH_WINDOWS "cmd /c copy C:\\\\pgBuild\\\\libiconv\\\\lib\\\\iconv.lib $PG_PATH_WINDOWS\\\\output\\\\lib" || _die "Failed to copy a dependency lib on the windows build host"
