...
_postprocess_plpgsqlo() {
    ...
    _registration_plus_postprocess "$WD/plpgsqlo/staging"  "PLPGSQLO"         "plpgsqloVersion" "/etc/postgres-reg.ini" "plpgsqlo/$PG_MAJOR_VERSION" "plpgsqlo-$PG_MAJOR_VERSION" "plpgsqlo_installer" "$PG_MAJOR_VERSION" "$PG_MINOR_VERSION"
