...
_prep_plpgsqlo_windows() {
    ...
    cp -R postgres.windows/src/pl/plpgsql postgres.windows/src/pl/plpgsqlo || _die "Failed to create copy of plpgsql tree (postgres.windows/src/pl/plpgsql)"
    ...
    cp $WD/server/source/postgres.windows/src/backend/utils/adt/encode.c $WD/server/source/postgres.windows/src/pl/plpgsqlo/src || _die "Failed to copy encode.c"
    cp $WD/server/source/postgres.windows/contrib/pgcrypto/md5.c $WD/server/source/postgres.windows/src/pl/plpgsqlo/src || _die "Failed to copy md5.c"
    cp $WD/server/source/postgres.windows/contrib/pgcrypto/md5.h $WD/server/source/postgres.windows/src/pl/plpgsqlo/src || _die "Failed to copy md5.h"
    cp $WD/server/source/postgres.windows/contrib/pgcrypto/px.h $WD/server/source/postgres.windows/src/pl/plpgsqlo/src || _die "Failed to copy px.h"
