...
_prep_plpgsqlo_linux() {
    ...
    cp -R postgres.linux/src/pl/plpgsql postgres.linux/src/pl/plpgsqlo || _die "Failed to create copy of plpgsql tree (postgres.linux/src/pl/plpgsql)"
    ...
    cp $WD/server/source/postgres.linux/src/backend/utils/adt/encode.c $WD/server/source/postgres.linux/src/pl/plpgsqlo/src || _die "Failed to copy encode.c"
    cp $WD/server/source/postgres.linux/contrib/pgcrypto/md5.c $WD/server/source/postgres.linux/src/pl/plpgsqlo/src || _die "Failed to copy md5.c"
    cp $WD/server/source/postgres.linux/contrib/pgcrypto/md5.h $WD/server/source/postgres.linux/src/pl/plpgsqlo/src || _die "Failed to copy md5.h"
    cp $WD/server/source/postgres.linux/contrib/pgcrypto/px.h $WD/server/source/postgres.linux/src/pl/plpgsqlo/src || _die "Failed to copy px.h"
