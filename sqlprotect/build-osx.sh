...
_build_sqlprotect_osx() {
	...
	cp $PG_PATH_OSX/server/source/postgres.osx/contrib/SQLPROTECT/README-sqlprotect.postgresql $PG_PATH_OSX/sqlprotect/staging/osx/doc/README.sqlprotect || _die "Failed to copy README-sqlprotect.postgresql to staging directory"
