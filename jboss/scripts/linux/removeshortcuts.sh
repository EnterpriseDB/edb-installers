...
"$INSTALLDIR/installer/xdg/xdg-desktop-menu" uninstall --mode system \
        "$INSTALLDIR/scripts/xdg/pg-launchjboss.desktop"  || _warn "Failed to Remove the jboss menu"
      
# Remove the icon resources
"$INSTALLDIR/installer/xdg/xdg-icon-resource" uninstall --mode system --size 32 "$INSTALLDIR/scripts/images/pg-launchjboss.png"
...
_replace "<Filename>pg-launchjboss.desktop</Filename>" "" "$xdg_global_dir/pg-$BRANDING_STR.menu"
