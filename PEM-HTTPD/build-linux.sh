...
_postprocess_PEM-HTTPD_linux() {
    ...
    cp scripts/linux/configurePEMHTTPD.sh staging/linux/installer/PEM-HTTPD/configurePEMHTTPD.sh || _die "Failed to copy the configureApacheHTTPD script (scripts/linux/configurePEMHTTPD.sh)"
    chmod ugo+x staging/linux/installer/PEM-HTTPD/configurePEMHTTPD.sh
    ...
    cp scripts/linux/launchPEMHTTPD.sh staging/linux/scripts/launchPEMHTTPD.sh || _die "Failed to copy the launchApacheHTTPD script (scripts/linux/launchPEMHTTPD.sh)"
    chmod ugo+x staging/linux/scripts/launchPEMHTTPD.sh
    ...
    cp resources/xdg/pg-pemhttpd.directory staging/linux/scripts/xdg/pg-pemhttpd.directory || _die "Failed to copy a menu pick directory"
