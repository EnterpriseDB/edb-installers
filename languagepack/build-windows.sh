...
_postprocess_languagepack_windows() {
    ...
    scp -r $PG_SSH_WIN:$PG_LANGUAGEPACK_INSTALL_DIR_WIN\\\\Perl-5.16 $WD/languagepack/staging/$ARCH/Perl-5.16 || _die "Failed to get Perl-5.16 from windows build host"
