...
_postprocess_languagepack_linux() {
    ...
    ssh $PG_SSH_LINUX "mv $PG_LANGUAGEPACK_INSTALL_DIR_LINUX/$PG_VERSION_LANGUAGEPACK/* $PG_PATH_LINUX/languagepack/staging/linux && rm -rf $PG_LANGUAGEPACK_INSTALL_DIR_LINUX" || _die "Failed
 to copy the languagepack Source into the staging directory"
