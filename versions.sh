...
PG_TARBALL_POSTGRESQL=9.1rc1
PG_TARBALL_PGADMIN=1.14.0-rc1
...
PG_TARBALL_LIBEVENT=2.0.12-stable
...
PG_MINOR_VERSION=rc1

# Other package versions
PG_VERSION_APACHE=2.2.19
PG_VERSION_PHP=5.3.8
PG_VERSION_MEDIAWIKI=1.17.0
PG_VERSION_PHPBB=3.0.9
PG_VERSION_DRUPAL=6.22
PG_VERSION_DRUPAL7=7.7
