...
PG_TARBALL_POSTGRESQL=10.15
PG_TARBALL_PGADMIN=4.28
PG_TARBALL_DEBUGGER=0.93
PG_TARBALL_PLJAVA=1.4.0
PG_TARBALL_OPENSSL=1.1.1d
...
PG_VERSION_APACHE=2.4.41
PG_VERSION_WSGI=4.7.0
PG_VERSION_PHP=5.5.30
PG_VERSION_PHPPGADMIN=5.1
PG_VERSION_PGJDBC=42.2.18
PG_VERSION_PSQLODBC=12.02.0000
PG_VERSION_POSTGIS=2.4.8
