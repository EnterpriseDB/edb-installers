...
PG_TARBALL_POSTGRESQL=8.4.2
PG_TARBALL_PGADMIN=1.10.1
...
PG_BUILDNUM_HQAGENT=$PG_BUILDNUM_PGHYPERIC
...
PG_VERSION_DEVSERVER=8.5alpha3
...
PG_VERSION_HQAGENT=$PG_VERSION_PGHYPERIC
PG_VERSION_REPLICATIONSERVER=2.41
