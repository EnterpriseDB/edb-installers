...
PG_TARBALL_POSTGRESQL=9.3.14
PG_TARBALL_PGADMIN=1.18.1
PG_TARBALL_DEBUGGER=0.93
PG_TARBALL_PLJAVA=1.4.0
PG_TARBALL_OPENSSL=1.0.1p
PG_TARBALL_ZLIB=1.2.7
PG_TARBALL_GEOS=3.3.9

# Build nums
PG_BUILDNUM_APACHEPHP=5
...
PG_JAR_POSTGRESQL=$PG_VERSION_PGJDBC.jdbc4
