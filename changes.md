# PostgreSQL installer release 15.19-4 (2026-09-08)
## Changes 🛠️
...
# PostgreSQL installer release 15.19-3 (2026-09-01)
## Changes 🛠️
...
# PostgreSQL installer release 15.19-2 (2026-08-31)
## Changes 🛠️
- **Dependencies (macOS & Windows)**
...
# PostgreSQL installer release 15.19-1 (2026-08-13)
## Changes 🛠️
- Update `pgAdmin4` to version `9.17`

- **Dependencies (macOS & Windows)**
    - Update `openssl` version to `3.5.7`
    - Update `wxwidgests` to version `3.2.11`
    - Update `curl` to version `8.21.0`

-------------------------------------------------------------------------------------------------------------------------------

# PostgreSQL installer release 15.18-2 (2026-06-11)
## Changes 🛠️
- **Dependencies (macOS & Windows)**
...
# PostgreSQL installer release 15.17-2 (2026-03-06)
## Changes 🛠️
- **Dependencies (MacOS & Windows)**
...
# PostgreSQL installer release 15.17-1 (2026-02-26)
## Changes 🛠️
- **Dependencies (MacOS & Windows)**
...
# PostgreSQL installer release 15.15-3 (2026-02-09)
## Changes 🛠️
...
# PostgreSQL installer release 15.15-1 (2025-11-13)
## Changes 🛠️
...
# PostgreSQL installer release 15.14-2 (2025-10-09)
## Changes 🛠️
- **Dependencies (MacOS & Windows)**
