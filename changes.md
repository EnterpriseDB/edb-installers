# PostgreSQL installer release 14.24-2 (2026-08-31)
## Changes 🛠️
- **Dependencies (macOS & Windows)**
    - Update `openssl` version to `1.1.1zi`
...
# PostgreSQL installer release 14.22-3 (2026-04-15)
## Changes 🛠️
- Update `pgAdmin4` to version `9.14`
  
- **Dependencies (MacOS & Windows)**
    - Update `openssl` version to `1.1.1zg`
...
# PostgreSQL installer release 14.21-1 (2026-02-12)
## Changes 🛠️
...
# PostgreSQL installer release 14.20-2 (2025-12-12)
## Changes 🛠️
