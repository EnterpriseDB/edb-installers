...
"$INSTALLDIR/Drupal7/installer/xdg/xdg-desktop-menu" uninstall --mode system  \
    "$INSTALLDIR/Drupal7/scripts/xdg/pg-launchDrupal.desktop"  || _warn "Failed to remove the Drupal7 menu"
...
_replace "<Filename>pg-launchDrupal.desktop</Filename>" "" "$xdg_global_dir/pg-$BRANDING_STR.menu"
