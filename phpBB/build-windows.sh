...
_build_phpBB_windows() {
    ...
    cp -R server/staging/windows/bin/libintl.dll phpBB/staging/windows/instscripts/ || _die "Failed to copy dependent libs"
    cp -R server/staging/windows/bin/libiconv2.dll phpBB/staging/windows/instscripts/ || _die "Failed to copy dependent libs"
