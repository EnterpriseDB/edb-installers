...
_build_phpBB_windows() {
    ...
    cp -R server/staging/windows/bin/gssapi32.dll phpBB/staging/windows/instscripts/ || _die "Failed to copy dependent libs"
    ...
    cp -R server/staging/windows/bin/libiconv-2.dll phpBB/staging/windows/instscripts/ || _die "Failed to copy dependent libs"
    cp -R server/staging/windows/bin/comerr32.dll phpBB/staging/windows/instscripts/ || _die "Failed to copy dependent libs"
    cp -R server/staging/windows/bin/krb5_32.dll phpBB/staging/windows/instscripts/ || _die "Failed to copy dependent libs"
    cp -R server/staging/windows/bin/k5sprt32.dll phpBB/staging/windows/instscripts/ || _die "Failed to copy dependent libs"
