...
_build_phpBB_osx() {
    ...
    cp -R $PG_PATH_OSX/server/staging/osx/lib/libssl* $PG_PATH_OSX/phpBB/staging/osx/instscripts/ || _die "Failed to copy libpq in instscripts"
    cp -R $PG_PATH_OSX/server/staging/osx/lib/libcrypto* $PG_PATH_OSX/phpBB/staging/osx/instscripts/ || _die "Failed to copy libpq in instscripts"
