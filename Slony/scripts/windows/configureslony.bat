...
move %1\lib\xxid.dll @@PKG_LIBDIR@@
...
echo "cd @@PKG_LIBDIR@@ && del /S /Q slevent.dll xxid.dll slony1_funcs.dll" >> %1/Slony/installer/Slony/removeFiles.bat
echo "cd @@SHARE_DIR@@ && FOR /F %%%%A IN ('dir /b slony1_*.*sql xxid.*.sql') DO (del /S /Q %%%%A)" >> %1/Slony/installer/Slony/removeFiles.bat
