...
_postprocess_Slony_linux_x64() {
    ...
    cp resources/xdg/pg-launchSlonyDocs.desktop staging/linux-x64/scripts/xdg/pg-launchSlonyDocs-$SLONY_VERSION_STR-$PG_VERSION_STR.desktop || _die "Failed to copy a menu pick desktop"
