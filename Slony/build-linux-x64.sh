...
_build_Slony_linux_x64() {
    ...
    ssh $PG_SSH_LINUX_X64 "cd $PG_PATH_LINUX_X64/Slony/source/slony.linux-x64/; export LD_LIBRARY_PATH=$PG_PGHOME_LINUX_X64/lib:$LD_LIBRARY_PATH; ./configure --with-pgconfigdir=$PG_PGHOME_LINUX_X64/bin"  || _die "Failed to configure slony"
