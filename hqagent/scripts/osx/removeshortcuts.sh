...
"$INSTALLDIR/installer/xdg/xdg-desktop-menu" uninstall --mode system \
	...
	"$INSTALLDIR/scripts/xdg/pghyperic-stop-$VERSION_STR.desktop" || _warn
	"Failed to remove the top level menu"
...
_replace "<Filename>pghyperic-launch-$VERSION_STR.desktop</Filename>" ""
"$xdg_global_dir/pghyperic-$BRANDING_STR.menu"
_replace "<Filename>pghyperic-start-$VERSION_STR.desktop</Filename>" ""
"$xdg_global_dir/pghyperic-$BRANDING_STR.menu"
_replace "<Filename>pghyperic-stop-$VERSION_STR.desktop</Filename>" ""
"$xdg_global_dir/pghyperic-$BRANDING_STR.menu"
