...
_build_pgmemcache_osx() {
    ...
    MACOSX_DEPLOYMENT_TARGET=10.5 ./configure --prefix=$PG_PGHOME_OSX  --disable-static --disable-dependency-tracking --enable-fat-binaries || _die "Failed to configure libmemcached (universal)"
