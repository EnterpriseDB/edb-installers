...
EOT
    ...
    do 
        ...
        install_name_tool -change "/opt/libiconv/lib/libiconv.2.dylib" "@loader_path/../../php/lib/libiconv.2.dylib" $file
    ...
    cp -R /opt/libiconv/lib/libiconv*.dylib $PG_STAGING/php/lib || _die "Failed to copy the dependency library"
