...
_build_PostGIS_linux_ppc64() {
    ...
    ssh $PG_SSH_LINUX_PPC64 "cd $PG_PATH_LINUX_PPC64/PostGIS/staging/linux-ppc64/PostGIS; cp $PG_PGHOME_LINUX_PPC64/doc/postgresql/postgis/postgis.html doc/postgis/" || _die "Failed to copy documentation"
    ssh $PG_SSH_LINUX_PPC64 "cd $PG_PATH_LINUX_PPC64/PostGIS/staging/linux-ppc64/PostGIS; cp $PG_PGHOME_LINUX_PPC64/doc/postgresql/postgis/README.postgis doc/postgis/" || _die "Failed to copy documentation"

    mkdir -p man/man1
    ssh $PG_SSH_LINUX_PPC64 "cd $PG_PATH_LINUX_PPC64/PostGIS/staging/linux-ppc64/PostGIS; cp $PG_PGHOME_LINUX_PPC64/share/man/man1/pgsql2shp.1 man/man1/" || _die "Failed to copy the man pages"
    ssh $PG_SSH_LINUX_PPC64 "cd $PG_PATH_LINUX_PPC64/PostGIS/staging/linux-ppc64/PostGIS; cp $PG_PGHOME_LINUX_PPC64/share/man/man1/shp2pgsql.1 man/man1/" || _die "Failed to copy the man pages"

    ssh $PG_SSH_LINUX_PPC64 "cd $PG_PATH_LINUX_PPC64/PostGIS/source/postgis.linux-ppc64; cp loader/README.shp2pgsql $PG_STAGING/PostGIS/doc/postgis" || _die "Failed to copy README.shp2pgsql "
    ssh $PG_SSH_LINUX_PPC64 "cd $PG_PATH_LINUX_PPC64/PostGIS/source/postgis.linux-ppc64; cp loader/README.pgsql2shp $PG_STAGING/PostGIS/doc/postgis" || _die "Failed to copy README.shp2pgsql "

    mkdir -p doc/postgis/jdbc/

    echo "Copying jdbc docs"
    ssh $PG_SSH_LINUX_PPC64 "cd $PG_PATH_LINUX_PPC64/PostGIS/source/postgis.linux-ppc64/java/jdbc; cp postgis-jdbc-javadoc.zip $PG_STAGING/PostGIS/doc/postgis/jdbc" || _die "Failed to copy jdbc docs "
    ssh $PG_SSH_LINUX_PPC64 "cd $PG_STAGING/PostGIS/doc/postgis/jdbc; unzip postgis-jdbc-javadoc.zip; rm postgis-jdbc-javadoc.zip" || _die "Failed to remove jdbc docs zip file"
