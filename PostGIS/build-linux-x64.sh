...
_postprocess_PostGIS_linux_x64() {
    ...
    cp resources/pg-launchPostGISJDBCDocs.png staging/linux-x64/scripts/images/pg-launchPostGISJDBCDocs-$POSTGIS_VERSION_STR-$PG_VERSION_STR.png || _die "Failed to copy a menu pick imgae"
