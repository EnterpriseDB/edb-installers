...
_postprocess_PostGIS_linux_x64() {
    ...
    cp resources/xdg/pg-launchJDBCDocs.desktop staging/linux-x64/scripts/xdg/pg-launchJDBCDocs-$POSTGIS_VERSION_STR.desktop || _die "Failed to copy a menu pick desktop"
