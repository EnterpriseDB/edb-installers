...
./configure --with-pgconfig=$POSTGRES_REMOTE_PATH/bin/pg_config --with-geosconfig=/opt/local/Current/bin/geos-config --with-projdir=/opt/local/Current --with-libiconv=/opt/local/Current --with-jsondir=/opt/local/Current || _die "Failed to configure postgis"
