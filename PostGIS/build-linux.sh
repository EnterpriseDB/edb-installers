...
_postprocess_PostGIS_linux() {
    ...
    cp resources/xdg/pg-launchJDBCDocs.desktop staging/linux/scripts/xdg/pg-launchJDBCDocs-$POSTGIS_VERSION_STR.desktop || _die "Failed to copy a menu pick desktop"
