...
_postprocess_PostGIS_linux() {
    ...
    cp resources/pg-launchPostGISJDBCDocs.png staging/linux/scripts/images/pg-launchPostGISJDBCDocs-$POSTGIS_VERSION_STR-$PG_VERSION_STR.png || _die "Failed to copy a menu pick imgae"
