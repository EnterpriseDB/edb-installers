...
"$PGHOME/bin/psql" -f "$INSTALLDIR/PostGIS/share/lwpostgis.sql" -d template_postgis
"$PGHOME/bin/psql" -f "$INSTALLDIR/PostGIS/share/spatial_ref_sys.sql" -d template_postgis
