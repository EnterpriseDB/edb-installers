...
"$INSTALLDIR/PostGIS/installer/xdg/xdg-icon-resource" uninstall --mode system --size 32 "$INSTALLDIR/PostGIS/scripts/images/pg-postgisi-$POSTGIS_VERSION_STR-$PG_VERSION_STR.png"
...
"$INSTALLDIR/PostGIS/installer/xdg/xdg-icon-resource" uninstall --mode system --size 32 "$INSTALLDIR/PostGIS/scripts/images/pg-launchPostGISJDBCDocs-$POSTGIS_VERSION_STR-$PG_VERSION_STR.png"
...
_replace "<Filename>pg-launchPostGISJDBCDocs-$POSTGIS_VERSION_STR.desktop</Filename>" "" "$xdg_global_dir/pg-$BRANDING_STR-pg-postgis-$POSTGIS_VERSION_STR-$PG_VERSION_STR.menu"
