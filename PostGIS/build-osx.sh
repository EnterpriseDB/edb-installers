...
cat <<EOT-POSTGIS >> $WD/PostGIS/build-postgis.sh
    ...
    install_name_tool -change "@loader_path/../../lib/libgdal.1.dylib" "@loader_path/libgdal.1.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/rtpostgis-$POSTGIS_MAJOR_VERSION.so
    ...
    sed -ie 's/nDROP/DROP/g' $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/share/extension/postgis*.sql
