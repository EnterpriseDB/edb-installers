...
cat <<EOT-POSTGIS > $WD/PostGIS/build-postgis.sh
    ...
    PATH=/opt/local/Current/ImageMagick/bin:$PATH LD_LIBRARY_PATH=/opt/local/Current/lib:$LD_LIBRARY_PATH; CFLAGS="$PG_ARCH_OSX_CFLAGS -arch i386" LDFLAGS="-L/opt/local/Current/lib $PG_ARCH_OSX_LDFLAGS -arch i386" PATH=/opt/local/Current/bin:$PG_PERL_OSX/bin:$PATH MACOSX_DEPLOYMENT_TARGET=$MACOSX_MIN_VERSION ./configure --with-pgconfig=$PG_PGHOME_OSX/bin/pg_config --with-geosconfig=/opt/local/Current/bin/geos-config --with-projdir=/opt/local/Current --with-xsldir=$PG_DOCBOOK_OSX  --with-gdalconfig=/opt/local/Current/bin/gdal-config --with-xml2config=/opt/local/Current/bin/xml2-config --with-libiconv=/opt/local/Current --with-jsondir=/opt/local/Current || _die "Failed to configure PostGIS for i386"
    mv postgis_config.h postgis_config_i386.h

    echo "Configuring the PostGIS source tree for x86_64"
    PATH=/opt/local/Current/ImageMagick/bin:$PATH LD_LIBRARY_PATH=/opt/local/Current/lib:$LD_LIBRARY_PATH; CFLAGS="$PG_ARCH_OSX_CFLAGS -arch x86_64" LDFLAGS="-L/opt/local/Current/lib $PG_ARCH_OSX_LDFLAGS -arch x86_64" MACOSX_DEPLOYMENT_TARGET=$MACOSX_MIN_VERSION PATH=/opt/local/Current/bin:$PG_PERL_OSX/bin:$PATH ./configure --with-pgconfig=$PG_PGHOME_OSX/bin/pg_config --with-geosconfig=/opt/local/Current/bin/geos-config --with-projdir=/opt/local/Current --with-xsldir=$PG_DOCBOOK_OSX --with-gdalconfig=/opt/local/Current/bin/gdal-config --with-xml2config=/opt/local/Current/bin/xml2-config --with-libiconv=/opt/local/Current --with-jsondir=/opt/local/Current || _die "Failed to configure PostGIS for x86_64"
    mv postgis_config.h postgis_config_x86_64.h

    echo "Configuring the PostGIS source tree for Universal"
    PATH=/opt/local/Current/ImageMagick/bin:$PATH LD_LIBRARY_PATH=/opt/local/Current/lib:$LD_LIBRARY_PATH; CFLAGS="$PG_ARCH_OSX_CFLAGS -arch x86_64 -arch i386" LDFLAGS="-L/opt/local/Current/lib $PG_ARCH_OSX_LDFLAGS -arch x86_64 -arch i386" MACOSX_DEPLOYMENT_TARGET=$MACOSX_MIN_VERSION PATH=/opt/local/Current/bin:$PG_PERL_OSX/bin:$PATH ./configure --with-pgconfig=$PG_PGHOME_OSX/bin/pg_config --with-geosconfig=/opt/local/Current/bin/geos-config --with-projdir=/opt/local/Current --with-xsldir=$PG_DOCBOOK_OSX --with-gdalconfig=/opt/local/Current/bin/gdal-config --with-xml2config=/opt/local/Current/bin/xml2-config --with-libiconv=/opt/local/Current --with-jsondir=/opt/local/Current || _die "Failed to configure PostGIS for x86_64"
    ...
    LDFLAGS="-L/opt/local/Current/lib -arch x86_64 -arch i386" CFLAGS="$PG_ARCH_OSX_CFLAGS -arch x86_64 -arch i386" MACOSX_DEPLOYMENT_TARGET=$MACOSX_MIN_VERSION make || _die "Failed to build PostGIS"
    ...
    make clean
    LDFLAGS="-L/opt/local/Current/lib -arch x86_64 -arch i386" CFLAGS="$PG_ARCH_OSX_CFLAGS -arch x86_64 -arch i386" MACOSX_DEPLOYMENT_TARGET=$MACOSX_MIN_VERSION make|| _die "Failed to build postgis-doc"
    cd $PG_PATH_OSX/PostGIS/source/postgis.osx/doc; 
    LDFLAGS="-L/opt/local/Current/lib -arch x86_64 -arch i386" CFLAGS="$PG_ARCH_OSX_CFLAGS -arch x86_64 -arch i386" MACOSX_DEPLOYMENT_TARGET=$MACOSX_MIN_VERSION make html || _die "Failed to build postgis-doc"
...
cat <<EOT-POSTGIS >> $WD/PostGIS/build-postgis.sh
    ...
    install_name_tool -change "@loader_path/../../lib/libjson-c.2.dylib" "@loader_path/libjson-c.2.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/libgdal.20.dylib
    ...
    install_name_tool -change "@loader_path/../../lib/libjson-c.2.dylib" "@loader_path/libjson-c.2.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/postgis-$POSTGIS_MAJOR_VERSION.so
    install_name_tool -change "@loader_path/../../lib/libjson-c.2.dylib" "@loader_path/libjson-c.2.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/rtpostgis-$POSTGIS_MAJOR_VERSION.so
    install_name_tool -change "@loader_path/../../lib/libproj.9.dylib" "@loader_path/libproj.9.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/postgis-$POSTGIS_MAJOR_VERSION.so
    install_name_tool -change "@loader_path/../../lib/libproj.9.dylib" "@loader_path/libproj.9.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/rtpostgis-$POSTGIS_MAJOR_VERSION.so
    ...
    install_name_tool -change "@loader_path/../../lib/libproj.9.dylib" "@loader_path/libproj.9.dylib" "$PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/postgis_topology-$POSTGIS_MAJOR_VERSION.so"
    ...
    install_name_tool -change "@loader_path/../../lib/libproj.9.dylib" "@loader_path/libproj.9.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/liblwgeom-$POSTGIS_MAJOR_VERSION.\$LIBLWGEOM_IFACE_CUR.dylib
    install_name_tool -change "@loader_path/../../lib/libjson-c.2.dylib" "@loader_path/libjson-c.2.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/lib/liblwgeom-$POSTGIS_MAJOR_VERSION.\$LIBLWGEOM_IFACE_CUR.dylib
    ...
    install_name_tool -change "@loader_path/../lib/libproj.9.dylib" "@loader_path/../lib/postgresql/libproj.9.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/bin/pgsql2shp
    ...
    install_name_tool -change "@loader_path/../lib/libproj.9.dylib" "@loader_path/../lib/postgresql/libproj.9.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/bin/shp2pgsql
    ...
    install_name_tool -change "@loader_path/../lib/libproj.9.dylib" "@loader_path/../lib/postgresql/libproj.9.dylib" $PG_PATH_OSX/PostGIS/staging/osx.build/PostGIS/bin/raster2pgsql
